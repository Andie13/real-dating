    ...
    <div class="container-fluid">
        <!--        <div class="header col-lg-12 col-xs-12 ">
                    ...
                    <div class="col-lg-4 col-xs-12 logo">
                        <p id="headerImp">
                            <img id="headerImg" src="<?php echo base_url(); ?>assets/images/Logo-RD.png" alt="logo"/>
                        </p>
                    </div>
        ...
        <div class=" col-lg-12 col-xs-12  ">
            ...
            <div class="col-lg-12 citySearch col-xs-12">
            ...
            <div class=" col-lg-12  ">
                ...
                <img  class="wellogo" style="width: 25%;" src="<?php echo base_url(); ?>assets/images/Logo-RD.png" alt="logo"/>
