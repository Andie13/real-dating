...
<html lang="fr">
    <head>
        ...
        <title>RealDating Accueil</title>
        <meta charset="utf-8" />
...
<!--            <script src="<?php echo base_url() ?>assets/tools/js/jquery-1.11.2.min.js" type="text/javascript"></script>-->
        ...
        <link href="<?php echo base_url(); ?>assets/tools/plugins/pace/pace-theme-flash.css" rel="stylesheet" type="text/css" media="screen"/>
        <link href="<?php echo base_url(); ?>assets/tools/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" media="screen"/>
        <link href="<?php echo base_url(); ?>assets/tools/plugins/bootstrap/css/bootstrap-theme.min.css" rel="stylesheet" type="text/css" media="screen"/>
        <link href="<?php echo base_url(); ?>assets/tools/fonts/font-awesome/css/font-awesome.css" rel="stylesheet" type="text/css" media="screen"/>
        <link href="<?php echo base_url(); ?>assets/tools/css/animate.min.css" rel="stylesheet" type="text/css" media="screen"/>
        <link href="<?php echo base_url(); ?>assets/tools/plugins/perfect-scrollbar/perfect-scrollbar.css" rel="stylesheet" type="text/css" media="screen"/>
        <link href="<?php echo base_url(); ?>assets/tools/css/style.css" rel="stylesheet" type="text/css" media="screen"/>
        <link href="<?php echo base_url(); ?>assets/tools/css/responsive.css" rel="stylesheet" type="text/css" media="screen"/>
        <!-- CORE CSS FRAMEWORK - END -->
        <!-- CORE CSS TEMPLATE - START -->
        <link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
        <!-- CORE CSS TEMPLATE - END -->

        <link href="<?php echo base_url() . "assets/tools/plugins/datatables/css/jquery.dataTables.css"; ?>" rel="stylesheet" type="text/css" media="screen"/>
        <link href="<?php echo base_url() . "assets/tools/plugins/datatables/extensions/TableTools/css/dataTables.tableTools.min.css"; ?>" rel="stylesheet" type="text/css" media="screen"/>
        <link href="<?php echo base_url() . "assets/tools/plugins/datatables/extensions/Responsive/css/dataTables.responsive.css"; ?>" rel="stylesheet" type="text/css" media="screen"/>
        <link href="<?php echo base_url() . "assets/tools/plugins/datatables/extensions/Responsive/bootstrap/3/dataTables.bootstrap.css"; ?>" rel="stylesheet" type="text/css" media="screen"/>
